...
# -*- coding: utf-8 -*-
#
# diffpy.srxconfutils documentation build configuration file, created by  # noqa: E501
...
try:
    fullversion = version("diffpy.srxconfutils")
except Exception:
...
modindex_common_prefix = ["diffpy.srxconfutils"]
...
html_context = {
    "display_github": True,
    "github_user": "diffpy",
    "github_repo": "diffpy.srxconfutils",
    "github_version": "main",
...
basename = "diffpy.srxconfutils".replace(" ", "").replace(".", "")
...
latex_documents = [
    (
        "index",
        "diffpy.srxconfutils.tex",
        "diffpy.srxconfutils Documentation",
        ab_authors,
        "manual",
    ),
]
